...
def cesar_chiffre_nb(nb,k):
    """
    Chiffre un nombre avec le chiffrement de César.
    """
    return (nb + k) % 26
...
def cesar_chiffre_mot(mot,k):
    """
    Chiffre un mot avec le chiffrement de César.
    """
...
# voyons ce que ca donne en essayant de chiffrer 'Afrique' avec une cle 2025
print(cesar_chiffre_mot('Afrique',3))
